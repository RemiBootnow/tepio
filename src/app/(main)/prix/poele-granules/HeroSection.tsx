...
export function HeroSection() {
  return (
    <HeroSectionBase
      ...
      subtitle="Le prix d'un poêle à granulés dépend du modèle, de la puissance et de la complexité d'installation. Découvrez les critères qui influencent le coût et les aides pour réduire votre reste à charge."
