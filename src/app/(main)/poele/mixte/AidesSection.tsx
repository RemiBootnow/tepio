...
//   PROMPT: Euro coins and a miniature wooden house on a pure black surface (#000000), lower two-thirds of frame, upper third empty black. No text, no documents. 3:4 portrait. Shot on full-frame 50mm f/1.8, shallow depth of field, warm editorial color grading, slightly lifted blacks, subtle film grain, soft directional light. Photorealistic.

// @IMAGE aide-cee.jpg (3:4, 1K)
//   CONTEXT: Card image for CEE energy savings prime. No documents.
//   PROMPT: A ceramic piggy bank next to split birch logs and a small pile of wood pellets on a deep dark green surface (#01322D), lower two-thirds of frame, upper third empty dark green. No text, no documents. 3:4 portrait. Shot on full-frame 50mm f/1.8, shallow depth of field, warm editorial color grading, slightly lifted blacks, subtle film grain, soft directional light. Photorealistic.

// @IMAGE aide-tva.jpg (3:4, 1K)
//   CONTEXT: Card image for reduced VAT. No documents.
//   PROMPT: A stove handle detail and a small potted plant on a warm beige surface (#FAF6F1), lower two-thirds of frame, upper third empty beige. No text, no documents. 3:4 portrait. Shot on full-frame 50mm f/1.8, shallow depth of field, warm editorial color grading, slightly lifted blacks, subtle film grain, soft directional light. Photorealistic.

export function AidesSection() {
  return (
    <CenterCarouselSection
      title="Des aides pour réduire le coût de votre poêle mixte"
      subtitle="Plusieurs dispositifs cumulables financent une partie de votre projet."
      primaryButtonLabel="Simuler mes aides"
      primaryButtonLink="/estimation"
    >
      <FeatureCardImage
        imageSrc="/poele/mixte/aide-maprime.jpg"
        imageAlt="MaPrimeRénov' pour poêle mixte"
        title="MaPrimeRénov' : jusqu'à 1 250 €"
        colorMode="dark"
      />
      <FeatureCardImage
        imageSrc="/poele/mixte/aide-cee.jpg"
        imageAlt="Prime CEE pour poêle mixte"
        title="Prime CEE : jusqu'à 250 €"
        colorMode="dark"
      />
      <FeatureCardImage
        imageSrc="/poele/mixte/aide-tva.jpg"
        imageAlt="TVA réduite pour poêle mixte"
