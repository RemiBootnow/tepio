...
export function InstallationSection() {
  return (
    <SplitSection
      ...
      subtitle="Votre artisan RGE réalise une visite technique, puis installe votre poêle à granulés en une journée. Raccordement au conduit de fumée, réglages et mise en service : tout est pris en charge. La certification RGE est indispensable pour bénéficier des aides de l'État."
