...
//   CONTEXT: Hero section for the pellet stove SEO page. Black wall, modern pellet stove on the right.
...
export function HeroSection() {
  return (
    <HeroSectionBase
      ...
      title="Poêle à pellets : une chaleur douce et automatisée"
      subtitle="Le poêle à pellets offre un chauffage programmable, silencieux et performant. Profitez d'un rendement jusqu'à 95 % et de multiples aides pour financer votre projet."
