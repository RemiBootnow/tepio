...
const headingStyles = {
  ...
  // Mobile: 32px/32px, Desktop: 54px/54px, tracking -0.5px (desktop -1px)
  h2: "text-[32px] leading-[32px] md:text-[54px] md:leading-[54px] font-bold tracking-[-0.5px] md:tracking-[-1px] font-heading",
